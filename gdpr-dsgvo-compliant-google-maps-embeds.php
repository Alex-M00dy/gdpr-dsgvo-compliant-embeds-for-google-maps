<?php
/**
 * Plugin Name:     GDPR-DSGVO compliant Google Maps Embeds
 ...
 * Text Domain:     gdpr-dsgvo-compliant-google-maps-embeds
 ...
 */
 ...
 function dsgvo_gm_plugin_action_links( $links ) {
    $settings_label = __( 'Settings', 'gdpr-dsgvo-compliant-google-maps-embeds' );
    $buy_label      = __( 'Buy Professional License', 'gdpr-dsgvo-compliant-google-maps-embeds' );
...
add_action( 'plugins_loaded', function() {
    load_plugin_textdomain( 'gdpr-dsgvo-compliant-google-maps-embeds', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
} );
...
function dsgvo_gm_enqueue_assets() {
    ...
    wp_localize_script( 'dsgvo-gm-script', 'dsgvoGm', array(
        'buttonText' => __( 'Load Google Maps', 'gdpr-dsgvo-compliant-google-maps-embeds' ),
    ) );
}
